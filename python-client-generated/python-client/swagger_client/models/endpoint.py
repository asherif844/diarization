...
class Endpoint(object):
    ...
    def __init__(self, concurrent_recognitions=None, id=None, name=None, description=None, endpoint_urls=None, endpoint_kind=None, last_action_date_time=None, status=None, created_date_time=None, content_logging_enabled=None, models=None, properties=None, locale=None):  # noqa: E501
