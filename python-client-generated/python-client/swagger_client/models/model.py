...
class Model(object):
    ...
    def __init__(self, id=None, name=None, description=None, model_kind=None, text=None, base_model=None, datasets=None, properties=None, locale=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
    ...
    def model_kind(self, model_kind):
        ...
        allowed_values = ["None", "Acoustic", "Language", "AcousticAndLanguage", "CustomVoice", "Sentiment", "LanguageIdentification", "Diarization", "Keyword", "PronunciationScore"]  # noqa: E501
